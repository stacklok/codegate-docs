...
<Tabs groupId='installer' queryString='installer'>
  ...
  <TabItem value='binary' label='Pre-compiled binaries'>
    Download the appropriate binary for your platform from the [ToolHive releases page](https://github.com/stacklok/toolhive/releases).
...
that lets AI assistants get the contents of a website. To learn more about the
...
and starts the server. It also sets up a proxy that lets your AI assistant
