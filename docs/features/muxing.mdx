...
```mermaid
flowchart LR
    Client(AI Assistant<br>or Agent):::secondary
    CodeGate{CodeGate}:::primary
    WS1[Workspace-A]:::primary
    WS2[Workspace-B]:::primary
    WS3[Workspace-C]:::primary
    LLM1(OpenAI/<br>o3-mini):::tertiary
    LLM2(Ollama/<br>deepseek-r1):::tertiary
    LLM3(OpenRouter/<br>claude-35-sonnet):::tertiary
