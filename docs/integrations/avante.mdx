...
To verify the configurtion, type `:AvanteChat` to start the **avante.nvim**
...
To take advantage of CodeGate's [model muxing feature](/features/muxing), use
**avante.nvim**'s OpenAI provider with the following configuration:
