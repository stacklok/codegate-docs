...
CodeGate supports OpenAI and OpenAI-compatible APIs with Claude Coder.
...
With CodeGate's default configuration, you'll need an
[OpenAI API](https://openai.com/api/) account. To use a different
OpenAI-compatible endpoint such as OpenRouter, set the `CODEGATE_OPENAI_URL`
...
1. In the **Provider Settings**, select **OpenAI Compatible**. Set the **Base
   URL** to `http://localhost:8989/openai`.

1. Enter the **Model ID** (example: `gpt-4o-mini`) and your API key.

   <Columns>
     <Column className='text--left'>
       <ThemedImage
         alt='Claude Coder extension settings step 1'
         sources={{
           light: useBaseUrl('/img/integrations/kodu-settings-1-light.webp'),
           dark: useBaseUrl('/img/integrations/kodu-settings-1-dark.webp'),
         }}
         width={'600px'}
       />
     </Column>
     <Column className='text--left'>
       <ThemedImage
         alt='Claude Coder extension settings step 2'
         sources={{
           light: useBaseUrl('/img/integrations/kodu-settings-2-light.webp'),
           dark: useBaseUrl('/img/integrations/kodu-settings-2-dark.webp'),
         }}
         width={'600px'}
       />
     </Column>
