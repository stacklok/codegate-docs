...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/img/codegate/quickstart/continue-config-light.webp'),
    dark: useBaseUrl('/img/codegate/quickstart/continue-config-dark.webp'),
  }}
  width={'500px'}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl(
      '/img/codegate/quickstart/quickstart-continue-model-light.webp'
    ),
    dark: useBaseUrl(
      '/img/codegate/quickstart/quickstart-continue-model-dark.webp'
    ),
  }}
  width={'600px'}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl(
      '/img/codegate/quickstart/quickstart-continue-secrets-result-light.webp'
    ),
    dark: useBaseUrl(
      '/img/codegate/quickstart/quickstart-continue-secrets-result-dark.webp'
    ),
  }}
  width={'600px'}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl(
      '/img/codegate/quickstart/quickstart-continue-dependencies-result-light.webp'
    ),
    dark: useBaseUrl(
      '/img/codegate/quickstart/quickstart-continue-dependencies-result-dark.webp'
    ),
  }}
  width={'600px'}
/>
