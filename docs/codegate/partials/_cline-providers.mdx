...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl(
      '/img/codegate/integrations/cline-provider-mux-light.webp'
    ),
    dark: useBaseUrl('/img/codegate/integrations/cline-provider-mux-dark.webp'),
  }}
  width={'540px'}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl(
      '/img/codegate/integrations/cline-provider-anthropic-light.webp'
    ),
    dark: useBaseUrl(
      '/img/codegate/integrations/cline-provider-anthropic-dark.webp'
    ),
  }}
  width={'540px'}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/img/codegate/integrations/lmstudio-server-light.webp'),
    dark: useBaseUrl('/img/codegate/integrations/lmstudio-server-dark.webp'),
  }}
  width={'800px'}
/>
...
[Configure CodeGate](/codegate/how-to/configure.md).
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl(
      '/img/codegate/integrations/cline-provider-lmstudio-light.webp'
    ),
    dark: useBaseUrl(
      '/img/codegate/integrations/cline-provider-lmstudio-dark.webp'
    ),
  }}
  width={'635px'}
/>
...
set to the correct URL. See [Configure CodeGate](/codegate/how-to/configure.md).
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl(
      '/img/codegate/integrations/cline-provider-ollama-light.webp'
    ),
    dark: useBaseUrl(
      '/img/codegate/integrations/cline-provider-ollama-dark.webp'
    ),
  }}
  width={'540px'}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl(
      '/img/codegate/integrations/cline-provider-openai-light.webp'
    ),
    dark: useBaseUrl(
      '/img/codegate/integrations/cline-provider-openai-dark.webp'
    ),
  }}
  width={'540px'}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl(
      '/img/codegate/integrations/cline-provider-openrouter-light.webp'
    ),
    dark: useBaseUrl(
      '/img/codegate/integrations/cline-provider-openrouter-dark.webp'
    ),
  }}
  width={'540px'}
/>
