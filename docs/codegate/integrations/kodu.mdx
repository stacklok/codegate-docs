...
1. On the **Preferences** tab, scroll down and click the link next to "Want to
   ...
   <ThemedImage
     ...
     sources={{
       light: useBaseUrl('/img/codegate/integrations/kodu-settings-light.webp'),
       dark: useBaseUrl('/img/codegate/integrations/kodu-settings-dark.webp'),
     }}
     width={'480px'}
   />
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl(
      '/img/codegate/integrations/kodu-codegate-version-light.webp'
    ),
    dark: useBaseUrl(
      '/img/codegate/integrations/kodu-codegate-version-dark.webp'
    ),
  }}
  width={'520px'}
/>
