...
1. Open the Cline extension sidebar from the VS Code Activity Bar. Note your
   ...
   <ThemedImage
     ...
     sources={{
       light: useBaseUrl(
         '/img/codegate/integrations/cline-mode-plan-light.webp'
       ),
       dark: useBaseUrl('/img/codegate/integrations/cline-mode-plan-dark.webp'),
     }}
     width={'400px'}
   />
   <ThemedImage
     ...
     sources={{
       light: useBaseUrl(
         '/img/codegate/integrations/cline-mode-act-light.webp'
       ),
       dark: useBaseUrl('/img/codegate/integrations/cline-mode-act-dark.webp'),
     }}
     width={'400px'}
   />
...
1. Open the Cline settings using the gear icon.
   ...
   <ThemedImage
     ...
     sources={{
       light: useBaseUrl(
         '/img/codegate/integrations/cline-settings-light.webp'
       ),
       dark: useBaseUrl('/img/codegate/integrations/cline-settings-dark.webp'),
     }}
     width={'540px'}
   />
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl(
      '/img/codegate/integrations/cline-codegate-version-light.webp'
    ),
    dark: useBaseUrl(
      '/img/codegate/integrations/cline-codegate-version-dark.webp'
    ),
  }}
  width={'490px'}
/>
